...
export const EasyPrivateTokenContractArtifact = loadContractArtifact(EasyPrivateTokenContractArtifactJson as NoirCompiledContract);
...
export class EasyPrivateTokenContract extends ContractBase {
  ...
  public static deploy(wallet: Wallet, initial_supply: (bigint | number), owner: AztecAddressLike) {
    return new DeployMethod<EasyPrivateTokenContract>(Point.ZERO, wallet, EasyPrivateTokenContractArtifact, EasyPrivateTokenContract.at, Array.from(arguments).slice(1));
  }

  /**
   * Creates a tx to deploy a new instance of this contract using the specified public key to derive the address.
   */
  public static deployWithPublicKey(publicKey: PublicKey, wallet: Wallet, initial_supply: (bigint | number), owner: AztecAddressLike) {
    return new DeployMethod<EasyPrivateTokenContract>(publicKey, wallet, EasyPrivateTokenContractArtifact, EasyPrivateTokenContract.at, Array.from(arguments).slice(2));
  }
